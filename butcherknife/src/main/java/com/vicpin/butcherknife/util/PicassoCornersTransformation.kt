...
class PicassoCornersTransformation(private val mRadius: Int, private val mMargin: Int,
                                   private val mCornerType: CornerType) : com.squareup.picasso.Transformation {
    ...
    override fun transform(source: Bitmap): Bitmap {
        ...
        val squaredBitmap = source.copy(Bitmap.Config.ARGB_8888, true)
